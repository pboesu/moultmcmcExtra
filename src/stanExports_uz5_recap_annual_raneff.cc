...
#include "stanExports_uz5_recap_annual_raneff.h"

RCPP_MODULE(stan_fit4uz5_recap_annual_raneff_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_uz5_recap_annual_raneff")
