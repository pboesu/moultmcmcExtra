...
//  covariates need to be on the individual level not the observation model for logical consistency
...
parameters {
  ...
  vector[N_years] u_year_mean;//ranef intercept on start date
  vector[N_years] u_year_duration;//ranef intercetpt on duration
  real<lower = 0> sd_year_mean;//ranef std dev
